...
use ITR\CatalogBundle\Entity\Seller;
use ITR\CatalogBundle\Form\SellerType;
...
class SellerController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CatalogBundle:Seller:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Seller $entity)
    {
        $form = $this->createForm(new SellerType(), $entity, array(
            'action' => $this->generateUrl('admin_seller_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('CatalogBundle:Seller:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CatalogBundle:Seller:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new SellerType(), $entity, array(
            'action' => $this->generateUrl('admin_seller_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_seller'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_seller_delete', array('id' => $id)))
            ->setMethod('DELETE')
