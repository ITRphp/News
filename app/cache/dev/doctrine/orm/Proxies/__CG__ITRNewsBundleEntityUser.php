...
class User extends \ITR\NewsBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ITR\\NewsBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'ITR\\NewsBundle\\Entity\\User' . "\0" . 'user_name', '' . "\0" . 'ITR\\NewsBundle\\Entity\\User' . "\0" . 'user_password', '' . "\0" . 'ITR\\NewsBundle\\Entity\\User' . "\0" . 'user_role', '' . "\0" . 'ITR\\NewsBundle\\Entity\\User' . "\0" . 'dispatches', '' . "\0" . 'ITR\\NewsBundle\\Entity\\User' . "\0" . 'user_email', '' . "\0" . 'ITR\\NewsBundle\\Entity\\User' . "\0" . 'passwordrecovery');
        }
