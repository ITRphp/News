...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/js/5d8a33b')) {
            // _assetic_5d8a33b
            if ($pathinfo === '/js/5d8a33b.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '5d8a33b',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_5d8a33b',);
            }

            if (0 === strpos($pathinfo, '/js/5d8a33b_')) {
                // _assetic_5d8a33b_0
                if ($pathinfo === '/js/5d8a33b_jquery-1.11.1_1.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '5d8a33b',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_5d8a33b_0',);
                }

                // _assetic_5d8a33b_1
                if ($pathinfo === '/js/5d8a33b_repeatPassword_2.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '5d8a33b',  'pos' => 1,  '_format' => 'js',  '_route' => '_assetic_5d8a33b_1',);
                }

                // _assetic_5d8a33b_2
                if ($pathinfo === '/js/5d8a33b_bootstrap.min_3.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '5d8a33b',  'pos' => 2,  '_format' => 'js',  '_route' => '_assetic_5d8a33b_2',);
                }

                // _assetic_5d8a33b_3
                if ($pathinfo === '/js/5d8a33b_jquery.hotkeys_4.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '5d8a33b',  'pos' => 3,  '_format' => 'js',  '_route' => '_assetic_5d8a33b_3',);
                }
