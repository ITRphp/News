...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/js/8f0beb9')) {
            // _assetic_8f0beb9
            if ($pathinfo === '/js/8f0beb9.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '8f0beb9',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_8f0beb9',);
            }

            if (0 === strpos($pathinfo, '/js/8f0beb9_')) {
                if (0 === strpos($pathinfo, '/js/8f0beb9_jquery-')) {
                    // _assetic_8f0beb9_0
                    if ($pathinfo === '/js/8f0beb9_jquery-1.11.1_1.js') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => '8f0beb9',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_8f0beb9_0',);
                    }

                    // _assetic_8f0beb9_1
                    if ($pathinfo === '/js/8f0beb9_jquery-ui_2.js') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => '8f0beb9',  'pos' => 1,  '_format' => 'js',  '_route' => '_assetic_8f0beb9_1',);
                    }

                }

                if (0 === strpos($pathinfo, '/js/8f0beb9_bootstrap')) {
                    // _assetic_8f0beb9_2
                    if ($pathinfo === '/js/8f0beb9_bootstrap.min_3.js') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => '8f0beb9',  'pos' => 2,  '_format' => 'js',  '_route' => '_assetic_8f0beb9_2',);
                    }

                    // _assetic_8f0beb9_3
                    if ($pathinfo === '/js/8f0beb9_bootstrap-select_4.js') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => '8f0beb9',  'pos' => 3,  '_format' => 'js',  '_route' => '_assetic_8f0beb9_3',);
                    }

                }

                // _assetic_8f0beb9_4
                if ($pathinfo === '/js/8f0beb9_news_5.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '8f0beb9',  'pos' => 4,  '_format' => 'js',  '_route' => '_assetic_8f0beb9_4',);
                }
        ...
        if (0 === strpos($pathinfo, '/css/1820aaf')) {
            ...
            if (0 === strpos($pathinfo, '/css/1820aaf_part_1_')) {
                if (0 === strpos($pathinfo, '/css/1820aaf_part_1_bootstrap')) {
                    // _assetic_1820aaf_0
                    if ($pathinfo === '/css/1820aaf_part_1_bootstrap-select_1.css') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => '1820aaf',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_1820aaf_0',);
                    }

                    // _assetic_1820aaf_1
                    if ($pathinfo === '/css/1820aaf_part_1_bootstrap.min_2.css') {
                ...
                // _assetic_1820aaf_2
                if ($pathinfo === '/css/1820aaf_part_1_jquery-ui_3.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '1820aaf',  'pos' => 2,  '_format' => 'css',  '_route' => '_assetic_1820aaf_2',);
                }

                // _assetic_1820aaf_3
                if ($pathinfo === '/css/1820aaf_part_1_style_4.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '1820aaf',  'pos' => 3,  '_format' => 'css',  '_route' => '_assetic_1820aaf_3',);
                }
        ...
        if (0 === strpos($pathinfo, '/images/a')) {
            if (0 === strpos($pathinfo, '/images/a0df14f')) {
                // _assetic_a0df14f
                if ($pathinfo === '/images/a0df14f.jpg') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'a0df14f',  'pos' => NULL,  '_format' => 'jpg',  '_route' => '_assetic_a0df14f',);
                }

                // _assetic_a0df14f_0
                if ($pathinfo === '/images/a0df14f_news_banner1_1.jpg') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'a0df14f',  'pos' => 0,  '_format' => 'jpg',  '_route' => '_assetic_a0df14f_0',);
                }

            }

            if (0 === strpos($pathinfo, '/images/a8a1897')) {
                // _assetic_a8a1897
                if ($pathinfo === '/images/a8a1897.jpg') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'a8a1897',  'pos' => NULL,  '_format' => 'jpg',  '_route' => '_assetic_a8a1897',);
                }

                // _assetic_a8a1897_0
                if ($pathinfo === '/images/a8a1897_news_banner2_1.jpg') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'a8a1897',  'pos' => 0,  '_format' => 'jpg',  '_route' => '_assetic_a8a1897_0',);
                }
        ...
        if (0 === strpos($pathinfo, '/images/e0e3182')) {
            // _assetic_e0e3182
            if ($pathinfo === '/images/e0e3182.png') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'e0e3182',  'pos' => NULL,  '_format' => 'png',  '_route' => '_assetic_e0e3182',);
            }

            // _assetic_e0e3182_0
            if ($pathinfo === '/images/e0e3182_cat_1.png') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'e0e3182',  'pos' => 0,  '_format' => 'png',  '_route' => '_assetic_e0e3182_0',);
            }
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'catalog_homepage')), array (  '_controller' => 'ITR\\CatalogBundle\\Controller\\DefaultController::indexAction',));
        }
        ...
        // sendletter
        if ($pathinfo === '/sendletter') {
            return array (  '_controller' => 'ITR\\NewsBundle\\Controller\\SendletterController::indexAction',  '_route' => 'sendletter',);
        }
